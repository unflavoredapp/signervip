...
@interface AVX512Manager : NSObject

@property (nonatomic, readonly, class) AVX512Manager *sharedManager;

@property (nonatomic, readonly) BOOL isHidden;
@property (nonatomic, readonly) AVX512ExplorerToolbar *toolbar;
...
typedef UIViewController * _Nullable(^AVX512CustomContentViewerFuture)(NSData *data);
