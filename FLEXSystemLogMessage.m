...
@implementation AVX512SystemLogMessage
...
+ (instancetype)logMessageFromASLMessage:(aslmsg)aslMessage {
    ...
    AVX512SystemLogMessage *message = [[self alloc] initWithDate:date sender:sender text:text messageID:identifier];
