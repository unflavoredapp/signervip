//
//  AVX512NetworkTransactionCell.m
//  Flipboard
//
...
NSString * const kAVX512NetworkTransactionCellIdentifier = @"kAVX512NetworkTransactionCellIdentifier";

@interface AVX512NetworkTransactionCell ()
...
@implementation AVX512NetworkTransactionCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        self.nameLabel.font = UIFont.avx512_defaultTableCellFont;
        [self.contentView addSubview:self.nameLabel];

        self.pathLabel = [UILabel new];
        self.pathLabel.font = UIFont.avx512_defaultTableCellFont;
...
- (void)setTransaction:(AVX512NetworkTransaction *)transaction {
...
- (void)layoutSubviews {
    ...
    self.nameLabel.textColor = self.transaction.displayAsError ? UIColor.redColor : AVX512Color.primaryTextColor;
...
+ (NSString *)reuseID {
    return kAVX512NetworkTransactionCellIdentifier;
}
