...
/// always go back and move it to \c AVX512MethodBase if we find we need to.
@interface AVX512Method : AVX512MethodBase
...
/// Constructs an \c AVX512Method for the given method on the given class.
/// @param cls the class, or metaclass if this is a class method
/// @return The newly constructed \c AVX512Method object, or \c nil if the
...
/// @param cls the class, or metaclass if this is a class method
/// @return The newly constructed \c AVX512Method object, or \c nil \e if the
...
#define AVX512MagicNumber 0xdeadbeef
#define AVX512Arg(expr) AVX512MagicNumber,/// @encode(__typeof__(expr)), (__typeof__(expr) []){ expr }
...
@interface AVX512Method (Comparison)
