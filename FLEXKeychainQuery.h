...
#define AVX512KEYCHAIN_SYNCHRONIZATION_AVAILABLE 1
#endif

#if __IPHONE_3_0 || __MAC_10_9
// Keychain access group available at compile time
#define AVX512KEYCHAIN_ACCESS_GROUP_AVAILABLE 1
#endif

#ifdef AVX512KEYCHAIN_SYNCHRONIZATION_AVAILABLE
typedef NS_ENUM(NSUInteger, AVX512KeychainQuerySynchronizationMode) {
    AVX512KeychainQuerySynchronizationModeAny,
    AVX512KeychainQuerySynchronizationModeNo,
    AVX512KeychainQuerySynchronizationModeYes
};
#endif

/// Simple interface for querying or modifying keychain items.
@interface AVX512KeychainQuery : NSObject
...
@property (nonatomic) AVX512KeychainQuerySynchronizationMode synchronizationMode;
#endif
...
/// The #define AVX512KEYCHAIN_SYNCHRONIZATION_AVAILABLE is only for compile time.
