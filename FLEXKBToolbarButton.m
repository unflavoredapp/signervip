...
@interface AVX512KBToolbarButton ()
@property (nonatomic      ) NSString *title;
@property (nonatomic, copy) AVX512KBToolbarAction buttonPressBlock;
...
@implementation AVX512KBToolbarButton

+ (instancetype)buttonWithTitle:(NSString *)title {
    return [[self alloc] initWithTitle:title];
}

+ (instancetype)buttonWithTitle:(NSString *)title action:(AVX512KBToolbarAction)eventHandler forControlEvents:(UIControlEvents)controlEvent {
    AVX512KBToolbarButton *newButton = [self buttonWithTitle:title];
...
- (id)initWithTitle:(NSString *)title {
    ...
    if (self) {
        ...
        self.layer.avx512_continuousCorners = YES;
...
- (void)addEventHandler:(AVX512KBToolbarAction)eventHandler forControlEvents:(UIControlEvents)controlEvent {
...
- (BOOL)isEqual:(id)object {
    if ([object isKindOfClass:[AVX512KBToolbarButton class]]) {
...
@implementation AVX512KBToolbarSuggestedButton
