//
//  AVX512FilteringTableViewController.h
//  FLEX
//
...
#pragma mark - AVX512TableViewFiltering
@protocol AVX512TableViewFiltering <AVX512SearchResultsUpdating>
...
@property (nonatomic, copy) NSArray<AVX512TableViewSection *> *sections;
...
@property (nonatomic, copy) NSArray<AVX512TableViewSection *> *allSections;

/// This computed property should filter \c allSections for assignment to \c sections
@property (nonatomic, readonly, copy) NSArray<AVX512TableViewSection *> *nonemptySections;
...
#pragma mark - AVX512FilteringTableViewController
/// A table view which implements \c UITableView* methods using arrays of
/// \c AVX512TableViewSection objects provied by a special delegate.
@interface AVX512FilteringTableViewController : AVX512TableViewController <AVX512TableViewFiltering>
...
@property (nonatomic, weak) id<AVX512TableViewFiltering> filterDelegate;
