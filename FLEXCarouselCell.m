...
- (void)updateAppearance {
    ...
    if (self.selected) {
        ...
        self.titleLabel.textColor = AVX512Color.deemphasizedTextColor;
    }
}
...
- (void)installConstraints {
    ...
    [self.titleLabel avx512_pinEdgesToSuperviewWithInsets:UIEdgeInsetsMake(10, 15, 8 + stripeHeight, 15)];
