...
typedef void (^AVX512MutableListCellForElement)(__kindof UITableViewCell *cell, id element, NSInteger row);
...
///
/// By default, \c kAVX512DetailCell is the reuse identifier used. If you need
...
@interface AVX512MutableListSection<__covariant ObjectType> : AVX512CollectionContentSection

/// Initializes a section with an empty list.
+ (instancetype)list:(NSArray<ObjectType> *)list
   cellConfiguration:(AVX512MutableListCellForElement)configurationBlock
...
/// A readwrite version of the same property in \c AVX512TableViewSection.h
///
