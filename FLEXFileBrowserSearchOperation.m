//
//  AVX512FileBrowserSearchOperation.m
//  FLEX
//
...
@implementation NSMutableArray (AVX512Stack)

- (void)avx512_push:(id)anObject {
...
@interface AVX512FileBrowserSearchOperation ()
...
@implementation AVX512FileBrowserSearchOperation
