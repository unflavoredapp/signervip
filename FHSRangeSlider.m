...
//        iv.userInteractionEnabled = YES;
    ...
    _track = newSubviewImageView(AVX512Resources.rangeSliderTrack);
    _fill = newSubviewImageView(AVX512Resources.rangeSliderFill);
    _leftHandle = newSubviewImageView(AVX512Resources.rangeSliderLeftHandle);
    _rightHandle = newSubviewImageView(AVX512Resources.rangeSliderRightHandle);
}
...
- (void)layoutSubviews {
    ...
    self.leftHandle.frame = AVX512RectMake(
    ...
    self.rightHandle.frame = AVX512RectMake(
    ...
    self.track.frame = AVX512RectMake(
        lhs.width / 2.f,
    ...
    self.fill.frame = AVX512RectMake(
