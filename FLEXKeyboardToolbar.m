...
@interface AVX512KeyboardToolbar ()
...
@implementation AVX512KeyboardToolbar
...
- (void)addButtons {
    ...
    for (AVX512KBToolbarButton *button in self.buttons) {
...
- (void)setButtons:(NSArray<AVX512KBToolbarButton *> *)buttons {
