...
@interface AVX512MITMDataSource<__covariant TransactionType> : NSObject
...
- (void)reloadData:(void (^_Nullable)(AVX512MITMDataSource *dataSource))completion;
- (void)filter:(NSString *)searchString completion:(void(^_Nullable)(AVX512MITMDataSource *dataSource))completion;
