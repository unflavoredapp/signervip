//
//  AVX512KeyboardShortcutManager.h
//  FLEX
//
...
@interface AVX512KeyboardShortcutManager : NSObject

@property (nonatomic, readonly, class) AVX512KeyboardShortcutManager *sharedManager;
