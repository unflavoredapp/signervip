...
@interface AVX512ExplorerToolbarItem : UIButton
...
+ (instancetype)itemWithTitle:(NSString *)title image:(UIImage *)image sibling:(nullable AVX512ExplorerToolbarItem *)backupItem;
...
@property (nonatomic, readonly) AVX512ExplorerToolbarItem *sibling;
...
@property (nonatomic, readonly) AVX512ExplorerToolbarItem *currentItem;
