...
#else
@class AVX512ObjectExplorerViewController;
#endif

NS_ASSUME_NONNULL_BEGIN

@interface AVX512ObjectExplorerFactory : NSObject <AVX512GlobalsEntry>

+ (nullable AVX512ObjectExplorerViewController *)explorerViewControllerForObject:(nullable id)object;
