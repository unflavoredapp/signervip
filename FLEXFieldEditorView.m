...
@interface AVX512FieldEditorView ()
...
@implementation AVX512FieldEditorView
...
- (void)setArgumentInputViews:(NSArray<AVX512ArgumentInputView *> *)argumentInputViews {
    if (![_argumentInputViews isEqual:argumentInputViews]) {
        
        for (AVX512ArgumentInputView *inputView in _argumentInputViews) {
            [inputView removeFromSuperview];
        }
        
        _argumentInputViews = argumentInputViews;
        
        for (AVX512ArgumentInputView *newInputView in argumentInputViews) {
...
+ (UIColor *)dividerColor {
    return AVX512Color.tertiaryBackgroundColor;
}
